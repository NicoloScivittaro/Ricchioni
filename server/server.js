...
import { BOARD_NODES, REGIONS } from "./game/boardData.js";
import { CHARACTERS } from "./game/characters.js";
import { ITEMS } from "./game/itemsData.js";
...
httpServer.listen(PORT, () => {
  console.log(`🚀 Server della Notte Brava attivo su http://localhost:${PORT}`);
});
