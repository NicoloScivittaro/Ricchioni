...
**multiple regions** (Appendix B adds a remote location), the
...
Amazon GameLift Servers applies them in the order you list, each breaking the previous one's
ties:
...
Appendix B adds a remote location — do it and this queue policy
